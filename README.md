...
The first test build is [ScheduleBrief Viewer v0.1.0-alpha](https://github.com/FXBGFoundry/schedulebrief-releases/releases/tag/v0.1.0-alpha).

Download:

- `ScheduleBrief-Viewer-Setup-v0.1.0-alpha.msi`
- `ScheduleBrief-Viewer-Setup-v0.1.0-alpha.msi.sha256`
...
The MSI installs for the current Windows user without administrator elevation:
...
ScheduleBrief Viewer operates locally. It does not upload schedule files, modify source schedules, use cloud APIs, create accounts, or include telemetry.

## Alpha limitations

This is an early test build. MPP/MPT, XER, PMXML, SDEF, and MPX require broader compatibility testing with authorized samples. The paid Briefing edition, editing, analysis, exports, licensing, updates, and cloud features are not implemented.
